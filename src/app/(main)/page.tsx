...
{`for (let i = 0; i < 5; i++) {
  console.log(i);
      ...
      {/* Footer */}
      <footer className="py-8 sm:py-12 bg-muted/50 border-t border-border">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/features/explanation" className="text-muted-foreground hover:text-sky-400">解説モード</Link></li>
                <li><Link href="/features/generation" className="text-muted-foreground hover:text-sky-400">生成モード</Link></li>
                <li><Link href="/features/brainstorm" className="text-muted-foreground hover:text-sky-400">壁打ちモード</Link></li>
                <li><Link href="/pricing" className="text-muted-foreground hover:text-sky-400">料金プラン</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/help" className="text-muted-foreground hover:text-sky-400">ヘルプ</Link></li>
                <li><a href="mailto:support@eurecode.jp" className="text-muted-foreground hover:text-sky-400">お問い合わせ</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/terms" className="text-muted-foreground hover:text-sky-400">利用規約</Link></li>
                <li><Link href="/privacy" className="text-muted-foreground hover:text-sky-400">プライバシーポリシー</Link></li>
                <li><Link href="/legal" className="text-muted-foreground hover:text-sky-400">特定商取引法に基づく表記</Link></li>
                <li><Link href="/company" className="text-muted-foreground hover:text-sky-400">運営会社</Link></li>
              </ul>
            </div>
          </div>
